...
export function PremiumDisclaimer({ feature, className = '' }: PremiumDisclaimerProps) {
  ...
  return (
    <div className={`rounded-xl p-4 mb-4 bg-orange-950/30 border border-orange-800 ${className}`}>
      <div className="flex items-start gap-4">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-8 h-8 rounded-full bg-orange-900 flex items-center justify-center">
